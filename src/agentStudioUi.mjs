...
const COPY = {
  en: {
    ...
    modes: {
      ...
      adapt_reel: {
        title: 'Adapt a Reel',
        description: 'Paste any public video link or upload the original video file.',
      },
    },
    ...
    cancel: 'Cancel run',
    contextTitle: 'This source blocks automatic access',
    contextDescription: 'Retry the public link or upload the video from your device. Gemini will inspect the actual frames, audio, and on-screen text.',
  ...
  uk: {
    ...
    modes: {
      ...
      adapt_reel: {
        ...
        description: 'Встав будь-яке публічне посилання на відео або завантаж оригінальний файл.',
      },
    },
    ...
    contextTitle: 'Це джерело блокує автоматичний доступ',
    contextDescription: 'Повтори отримання за посиланням або завантаж відео з пристрою. Gemini сам перевірить кадри, звук і текст на екрані.',
